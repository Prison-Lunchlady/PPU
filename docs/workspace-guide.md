...
1. [Protocol State](canonical/01-protocol-state.md)
2. [Decision Register](canonical/02-decision-register.md)
3. [Risk Register](canonical/03-risk-register.md)
4. [Active Hypotheses](canonical/04-active-hypotheses.md)
5. [Unresolved Questions](canonical/05-unresolved-questions.md)
6. [Research Library Index](canonical/06-research-library-index.md)
7. [Development Roadmap](roadmap/07-development-roadmap.md)
8. [Draft Monetary Constitution / Hypothesis Set](constitution/08-draft-constitution.md)
9. [Work Package Register](canonical/09-work-package-register.md)
10. [Review Gate Register](canonical/10-review-gate-register.md)

Supporting records: [structural review](../reviews/wp0a/wp0a-structural-review.md), [completion report](../reviews/wp0a/WP0A-report.md), [change log](../CHANGELOG.md), and original captures in evidence/.
...
Routine documentation implementation is delegated to the current operator. Brad owns approvals; specialist research owners remain unassigned until a package is authorized. Keep source snapshots separate from maintained records. Preserve read-only synced ChatGPT sources outside this repository. Commit authorized documentation changes and push them to the PPU GitHub repository; a local edit alone is not a remote update.
...
Current authority is SRC017 for the narrow revision, SRC016 for Gate 1A conditions, and the latest Protocol State. Earlier dated handoff statements describe historical submissions; they do not supersede the current gate register. GitHub remains the version-controlled source.
