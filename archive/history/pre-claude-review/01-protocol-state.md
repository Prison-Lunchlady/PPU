...
Draft liability: L = S × T + Q, with S circulating PPU and Q accepted unsettled redemption obligations. The treatment of queued tokens must be defined to avoid double counting (Q-006).
...
## Gate handoff
All ten records and the unmodified roadmap are available. Self-review identified and reconciled structural issues in the [review](../../../reviews/wp0a/wp0a-structural-review.md). Claude Opus review was unavailable: browser reached sign-in and no Claude connector was exposed. This is not independent review.
